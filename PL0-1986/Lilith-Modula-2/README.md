...
|PL0Scanner.MOD    |                                                   |
|                  |                                                   |
|wirth-1986a.pl0   |*Wirth's* multiply-divide-gcd-fact **PL/0** example|
|wirth-1986b.pl0   |*Wirth's* gcd **PL/0** example                     |
|wirth-1986c.pl0   |*Wirth's* **PL/0** syntactic errors example        |
